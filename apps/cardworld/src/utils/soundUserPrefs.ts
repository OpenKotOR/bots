/**
 * Canonical browser sound preferences for Cardworld (single JSON blob + migration).
 *
 * Does **not** delete `pazaak-sound-config` — that key may still be consumed by PazaakWorld
 * on the same origin until the user opens that app and migrates.
 *
 * @see docs/solutions/sound-architecture-pazaak-world.md (same model; app-specific canonical key)
 */

const CANONICAL_KEY = "openkotor-cardworld-sound-v2";
