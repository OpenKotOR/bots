...
PAZAAK_OAUTH_GOOGLE_CALLBACK_URL=https://openkotor.github.io/community-bots/pazaakworld/api/auth/oauth/google/callback

# Discord OAuth (Discord Developer Portal)
PAZAAK_OAUTH_DISCORD_CLIENT_ID=
PAZAAK_OAUTH_DISCORD_CLIENT_SECRET=
PAZAAK_OAUTH_DISCORD_CALLBACK_URL=https://openkotor.github.io/community-bots/pazaakworld/api/auth/oauth/discord/callback

# GitHub OAuth (GitHub OAuth Apps)
PAZAAK_OAUTH_GITHUB_CLIENT_ID=
PAZAAK_OAUTH_GITHUB_CLIENT_SECRET=
PAZAAK_OAUTH_GITHUB_CALLBACK_URL=https://openkotor.github.io/community-bots/pazaakworld/api/auth/oauth/github/callback
```
...
7. Add Authorized redirect URI:
   - `https://openkotor.github.io/community-bots/pazaakworld/api/auth/oauth/google/callback`
...
3. Under Redirects, add:
   - `https://openkotor.github.io/community-bots/pazaakworld/api/auth/oauth/discord/callback`
4. Save changes.
5. Copy values:
...
3. Set fields:
   ...
   - **Homepage URL**: `https://openkotor.github.io/community-bots/pazaakworld`
   - **Authorization callback URL**: `https://openkotor.github.io/community-bots/pazaakworld/api/auth/oauth/github/callback`
4. Register the app.
5. Copy values:
