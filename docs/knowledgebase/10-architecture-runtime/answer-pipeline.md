...
3. [REPO] Headless `ai-researchwizard` runs with approved web/GitHub URL roots (`traskApprovedResearchSources`); `kind=discord` catalog entries stay out of that allowlist.
...
- [trask-research-troubleshooting.md](../50-execution/trask-research-troubleshooting.md) — GPTR, timeouts, `INGEST_STATE_DIR`.
